...
reserves.at <- c(710,810,910,1010,1110,1210,1310,1410,711,811,911,1011,1111,1211,1311,1411,712,812,912,1012,1112,1212,1312,1412) # This determines which patches are marine reserves. Should be a list: e.g., for one reserve
...
save(output.array, file = here::here("data", "largenull8F.rda"))