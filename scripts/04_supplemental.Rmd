...
ggsave(p1, file = paste0("decline_mpa_pres_null.pdf"), path = here::here("figs", "presentation"), height = 10, width = 18)
...
ggsave(p2, file = paste0("decline_mpa_pres_mean.pdf"), path = here::here("figs", "presentation"), height = 10, width = 18)
```
