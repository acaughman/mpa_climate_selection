...
ggsave(s7, file = paste0("by_lat_collapse.pdf"), path = here::here("figs", "supp"), height = 25, width = 20)
```
...
temp <- ggplot(SSTdf) +
  ...
  scale_y_continuous(breaks = c(25, 27.5, 30, 32.5, 35), labels = c("0", "+ 2.5", "+ 5", "+ 7.5", "+ 10"))
