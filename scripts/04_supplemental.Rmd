...
ggsave(temp, file = paste0("temp.pdf"), path = here("figs", "climate"), height = 10, width = 10)
```
...
ggsave(mort_curve, file = paste0("mort_curve.pdf"), path = here("figs", "climate"), height = 10, width = 10)
```
