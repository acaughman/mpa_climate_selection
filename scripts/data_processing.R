...
load(file = here::here("data", "tests", "test_null.rda"))
...
ggsave(plot, file=paste0("test_null_h.pdf"), path = here::here("figs", "test"), height = 11, width = 8)
...
#ggsave(p3, file=paste0("test_null6.pdf"), path = here::here("figs", "test"), height = 11, width = 8)
