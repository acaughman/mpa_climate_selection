...
ggsave(f3, file = paste0("fig3.pdf"), path = here::here("figs"), height = 8, width = 10)
...
#         axis.ticks.x = element_blank())
# 
# ggsave(p2, file = paste0("genotype_summary_pres.pdf"), path = here::here("figs", "presentation"), height = 8, width = 15)
```
...
#   theme(panel.grid.minor = element_blank())
# 
# ggsave(p2, file = paste0("sum_geno.pdf"), path = here::here("figs"), height = 8, width = 15)
```
...
#   scale_color_viridis_d()
# 
# ggsave(p3, file = paste0("mpa_benefit_summary.pdf"), path = here::here("figs"), height = 10, width = 15)
```
...
#   scale_color_viridis_d()
# 
# ggsave(p4, file = paste0("sum_lat_geno_clim.pdf"), path = here::here("figs"), height = 8, width = 15)
```
...
#   coord_flip()
# 
# ggsave(p6, file = paste0("rate_lat.pdf"), path = here::here("figs"), height = 8, width = 15)
```
...
#   scale_color_manual(values = c("#5ec962", "#440154")) 
#   
# ggsave(p14, file = paste0("decline_sim_fishing_pressure.pdf"), path = here::here("figs"), height = 8, width = 15)
```
...
#   guides(fill="none")
#   
# ggsave(s2, file = paste0("decline_mpa.pdf"), path = here::here("figs", "supp"), height = 8, width = 15)
```