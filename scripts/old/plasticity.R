...
reserves.at <- c(124,144,164,125,145,165,126,146,166)
      ...
      for(i in 2:NUM.age.classes) {
        for(j in 1:NUM.sexes) {
          for(k in 1:NUM.genotypes) {
            ...
            if(reserve.patches[,,gen] == 1) {mean.dist = mean.dist - 100}
...
save(output.array, file = here::here("data", "plastic8F.rda"))