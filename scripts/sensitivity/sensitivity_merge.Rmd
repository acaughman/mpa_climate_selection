...
```{r}
df1 <- read_csv(here::here("sensitivity_analysis", "climate_rate", "med_shock_013.csv")) %>% 
  filter(rep == 1)

df2 <- read_csv(here::here("sensitivity_analysis", "climate_rate", "shock_med_sum.csv"))
```
...
write_csv(data, here::here("sensitivity_analysis", "climate_rate", "shock_med_sum.csv"))
```
