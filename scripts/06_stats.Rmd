...
write_csv(mean_change2, here::here("03_generated_data", "results", "rate_change_mpa_sum.csv"))
```
...
write_csv(change_mpa_fp, here::here("03_generated_data", "results", "fishing_pressure_change_mpa.csv"))
...
write_csv(temps_fp, here::here("03_generated_data", "results", "aa_peak_fishing_pressure.csv"))
```
...
write_csv(change_mpa_rate, here::here("03_generated_data", "results", "climate_rate_change_mpa.csv"))
...
write_csv(temps_rate, here::here("03_generated_data", "results", "aa_peak_climate_rate.csv"))
```
