...
rm(df11, df12, df13, df14, df15, df16, df19, df20, 
               df21, df22, df23, df24, df35, df36, df37, df38, df39, df40)

df_list2 = list(df11_2, df12_2, df13_2, df14_2, df15_2, df16_2, df19_2, df20_2, 
               df21_2, df22_2, df23_2, df24_2, df35_2, df36_2, df37_2, df38_2, df39_2, df40_2) %>% 
  reduce(full_join)
...
write_csv(dfs, here::here("03_generated_data", "summary_data", "full_sum_climate_rate.csv"))
```
