...
```{r}
df1 <- read_csv(here::here("sensitivity_analysis", "initial_SST", "mean_small_neg1.csv"))

df2 <- read_csv(here::here("sensitivity_analysis", "initial_SST", "mean_small_neg5.csv"))

df3 <- read_csv(here::here("sensitivity_analysis", "initial_SST", "mean_small0.csv"))

df4 <- read_csv(here::here("sensitivity_analysis", "initial_SST", "mean_small_pos5.csv"))

df5 <- read_csv(here::here("sensitivity_analysis", "initial_SST", "mean_small_pos1.csv"))
```
...
write_csv(data, here::here("sensitivity_analysis", "initial_SST", "mean_small_sum.csv"))
