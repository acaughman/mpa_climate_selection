...
```{r}
df1 <- read_csv(here::here("sensitivity_analysis", "density_dependence", "shock_small_001.csv"))

df2 <- read_csv(here::here("sensitivity_analysis", "density_dependence", "shock_small_002.csv"))
...
write_csv(data, here::here("sensitivity_analysis", "density_dependence", "shock_small_sum.csv"))
```
