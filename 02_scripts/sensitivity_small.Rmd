...
```{r}
df1 <- read_csv(here::here("sensitivity_analysis", "movement_pattern", "enso.csv"))

df2 <- read_csv(here::here("sensitivity_analysis", "movement_pattern", "enso_bias.csv"))

df3 <- read_csv(here::here("sensitivity_analysis", "movement_pattern", "enso_bias_wrap.csv"))
...
write_csv(data, here::here("sensitivity_analysis", "movement_pattern", "enso_small_sum.csv"))
```
