...
load(file = here::here("sensitivity_analysis", "movement_pattern", "null_bias.rda"))
...
write_csv(output_df, here::here("sensitivity_analysis", "movement_pattern", "null_bias.csv"))
