...
load(file = here::here("sensitivity_analysis", "density_dependence", "null_small_008.rda"))
...
write_csv(output_df, here::here("sensitivity_analysis", "density_dependence", "null_small_008.csv"))