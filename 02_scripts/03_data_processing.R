...
load(file = here::here("sensitivity_analysis", "fishing_pressure", "enso_small5.rda"))
...
write_csv(output_df, here::here("sensitivity_analysis", "fishing_pressure", "enso_small5.csv"))
