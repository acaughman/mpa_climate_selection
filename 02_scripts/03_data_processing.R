...
load(file = here::here("sensitivity_analysis", "thermal_breadth", "mean_shock_small6.rda"))
...
write_csv(output_df, here::here("sensitivity_analysis", "thermal_breadth", "mean_shock_small6.csv"))