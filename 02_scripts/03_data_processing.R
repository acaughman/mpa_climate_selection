...
load(file = here::here("test", "climate_pace", "null_small.rda"))
load(file = here::here("03_generated_data", "climate_layer" ,"mean2km.rda"))
...
write_csv(output_df, here::here("test","climate_pace", "mean2km.csv"))