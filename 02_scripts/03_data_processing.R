...
load(file = here::here("sensitivity_analysis", "initial_SST", "null_small_008.rda"))
...
write_csv(output_df, here::here("sensitivity_analysis", "initial_SST", "null_small_008.csv"))