...
```{r}
df1 <- read_csv(here::here("sensitivity_analysis", "movement_pattern", "null_med.csv"))

df2 <- read_csv(here::here("sensitivity_analysis", "movement_pattern", "null_med_bias.csv"))

df3 <- read_csv(here::here("sensitivity_analysis", "movement_pattern", "null_med_bias_wrap.csv"))

df4 <- read_csv(here::here("sensitivity_analysis", "movement_pattern", "null_med_004.csv"))
...
write_csv(data, here::here("sensitivity_analysis", "movement_pattern", "null_med_sum.csv"))
```
