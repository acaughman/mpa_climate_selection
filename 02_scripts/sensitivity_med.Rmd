...
```{r}
df1 <- read_csv(here::here("sensitivity_analysis", "density_dependence", "null_med_001.csv"))

df2 <- read_csv(here::here("sensitivity_analysis", "density_dependence", "null_med_002.csv"))

df3 <- read_csv(here::here("sensitivity_analysis", "density_dependence", "null_med_003.csv"))

df4 <- read_csv(here::here("sensitivity_analysis", "density_dependence", "null_med_004.csv"))

df5 <- read_csv(here::here("sensitivity_analysis", "density_dependence", "null_med_005.csv"))
```
...
write_csv(data, here::here("sensitivity_analysis", "density_dependence", "null_med_sum.csv"))
