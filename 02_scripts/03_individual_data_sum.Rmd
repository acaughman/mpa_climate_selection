...
```{r}
output_df <- read_csv(here::here("03_generated_data", "model_outputs", "model38_3.csv"))
...
output_sum2 = output_sum2 %>%
  ...
  mutate(freq = geno_pop_mean / pop_mean,
         mpa_size = "Medium",
         climate = "Shocks with Mean Shift",
         evolution = "No")

write_csv(output_sum2, here::here("03_generated_data", "summary_data", "summary_m38_3.csv"))
