...
```{r}
df1 <- read_csv(here::here("sensitivity_analysis", "initial_SST", "mean_shock_small_neg1.csv"))

df2 <- read_csv(here::here("sensitivity_analysis", "initial_SST", "mean_shock_small_neg5.csv"))
...
```{r}
p <- ggplot(mpa_df3, aes(generation, location_sum)) +
  geom_line() +
  theme_bw() +
  labs(
    x = "Year",
    y = "Population Density",
    color = "Initial Sea Surface Temperature"
  ) +
...
ggsave(plot, file = paste0("mean_shock_small.pdf"), path = here::here("sensitivity_analysis", "initial_SST"), height = 8, width = 15)
```
