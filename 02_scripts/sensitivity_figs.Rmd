...
```{r}
df1 <- read_csv(here::here("sensitivity_analysis", "density_dependence", "mean_001.csv"))

df2 <- read_csv(here::here("sensitivity_analysis", "density_dependence", "mean_002.csv"))

df3 <- read_csv(here::here("sensitivity_analysis", "density_dependence", "mean_003.csv"))

df4 <- read_csv(here::here("sensitivity_analysis", "density_dependence", "mean_004.csv"))

df5 <- read_csv(here::here("sensitivity_analysis", "density_dependence", "mean_005.csv"))
```
...
ggsave(plot, file = paste0("mean_small.pdf"), path = here::here("sensitivity_analysis", "density_dependence"), height = 8, width = 15)
```
