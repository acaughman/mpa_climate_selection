...
```{r}
df1 <- read_csv(here::here("sensitivity_analysis", "fishing_pressure", "null5.csv"))

df2 <- read_csv(here::here("sensitivity_analysis", "fishing_pressure", "null6.csv"))

df3 <- read_csv(here::here("sensitivity_analysis", "fishing_pressure", "null7.csv"))

df4 <- read_csv(here::here("sensitivity_analysis", "fishing_pressure", "null8.csv"))

df5 <- read_csv(here::here("sensitivity_analysis", "fishing_pressure", ".csv"))
```
...
sub = ggplot(data, aes(generation, location_sum)) +
  ...
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
    scale_color_viridis_d() + ylim(c(0, 10000)) +
  theme(legend.position = "none")

plot = p + inset_element(sub, right = .95, 
                  bottom = 0.5,
                  left= 0.3,
                  top = 0.96) + plot_annotation(tag_levels = "a")
# mean 66, null 117, shock c(136,66,124,79,35,143,130,71,82,90,25,73,80,103,51,34,142,40,86,141,97,137,113,144,122,132,149,129) EDIT WITH FINAL VALUES

ggsave(plot, file = paste0("null.pdf"), path = here::here("sensitivity_analysis", "fishing_pressure"), height = 8, width = 15)
```
