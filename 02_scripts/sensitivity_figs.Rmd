...
```{r}
df1 <- read_csv(here::here("sensitivity_analysis", "movement_pattern", "mean_shock.csv"))

df2 <- read_csv(here::here("sensitivity_analysis", "movement_pattern", "mean_shock_bias.csv"))

df3 <- read_csv(here::here("sensitivity_analysis", "movement_pattern", "mean_shock_bias_wrap.csv"))

df4 <- read_csv(here::here("sensitivity_analysis", "movement_pattern", "mean_shock_004.csv"))

df5 <- read_csv(here::here("sensitivity_analysis", "movement_pattern", "mean_shock_005.csv"))
```
...
ggsave(plot, file = paste0("mean_shock.pdf"), path = here::here("sensitivity_analysis", "movement_pattern"), height = 8, width = 15)
```
