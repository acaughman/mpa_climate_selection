...
```{r}
df1 <- read_csv(here::here("sensitivity_analysis", "movement_pattern", "null.csv"))

df2 <- read_csv(here::here("sensitivity_analysis", "movement_pattern", "null_bias.csv"))

df3 <- read_csv(here::here("sensitivity_analysis", "movement_pattern", "null_bias_wrap.csv"))
...
ggsave(plot, file = paste0("null.pdf"), path = here::here("sensitivity_analysis", "movement_pattern"), height = 8, width = 15)
```
