...
```{r}
df1 <- read_csv(here::here("sensitivity_analysis", "initial_SST", "mean_shock_med_pos2.csv"))

df2 <- read_csv(here::here("sensitivity_analysis", "initial_SST", "mean_shock_med_sum.csv"))
```
...
write_csv(data, here::here("sensitivity_analysis", "initial_SST", "mean_shock_med_sum.csv"))
```
