...
```{r}
df1 <- read_csv(here::here("sensitivity_analysis", "initial_SST", "shock_small0.csv"))

df2 <- read_csv(here::here("sensitivity_analysis", "initial_SST", "shock_small_sum.csv"))
```
...
write_csv(data, here::here("sensitivity_analysis", "initial_SST", "shock_small_sum.csv"))
```
