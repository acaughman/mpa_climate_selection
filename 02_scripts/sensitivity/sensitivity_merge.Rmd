...
```{r}
df1 <- read_csv(here::here("sensitivity_analysis", "movement_rate", "med_mean_shock_3_1.csv"))

df2 <- read_csv(here::here("sensitivity_analysis", "movement_rate", "mean_shock_med_sum.csv")) #%>%
  # filter(dd == 0.005) %>%
  # mutate(dd = "3/2")
```
...
write_csv(data, here::here("sensitivity_analysis", "movement_rate", "mean_shock_med_sum.csv"))
```
