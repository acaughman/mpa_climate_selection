...
```{r}
df1 <- read_csv(here::here("sensitivity_analysis", "movement_rate", "small_null_3_05.csv"))

df2 <- read_csv(here::here("sensitivity_analysis", "movement_rate", "null_small_sum.csv"))
```
...
write_csv(data, here::here("sensitivity_analysis", "movement_rate", "null_small_sum.csv"))
```
