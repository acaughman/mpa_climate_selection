...
```{r}
df1 <- read_csv(here::here("sensitivity_analysis", "initial_SST", "shock_large_neg5.csv"))

df2 <- read_csv(here::here("sensitivity_analysis", "initial_SST", "shock_large_neg1.csv")) 

df3 <- read_csv(here::here("sensitivity_analysis", "initial_SST", "shock_large0.csv"))

df4 <- read_csv(here::here("sensitivity_analysis", "initial_SST", "shock_large_pos5.csv"))

df5 <- read_csv(here::here("sensitivity_analysis", "initial_SST", "shock_large_pos1.csv"))

df6 <- read_csv(here::here("sensitivity_analysis", "initial_SST", "shock_large_pos2.csv"))
```
...
write_csv(data, here::here("sensitivity_analysis", "initial_SST", "shock_large_sum.csv"))
```
