...
```{r}
df1 <- read_csv(here::here("sensitivity_analysis", "thermal_breadth", "mean_shock_large3.csv"))

df2 <- read_csv(here::here("sensitivity_analysis", "movement_pattern", "mean_shock_large_sum.csv")) %>% 
  filter(dd == "random walk") %>% 
  mutate(dd  = 4)

df3 <- read_csv(here::here("sensitivity_analysis", "thermal_breadth", "mean_shock_large5.csv"))

df4 <- read_csv(here::here("sensitivity_analysis", "thermal_breadth", "mean_shock_large6.csv"))

# df5 <- read_csv(here::here("sensitivity_analysis", "thermal_breadth", "mean_shock_large_pos1.csv"))
# 
# df6 <- read_csv(here::here("sensitivity_analysis", "thermal_breadth", "mean_shock_large_pos2.csv"))
```
...
mpa_df1 <- output_sum1 %>%
  ...
  filter(lat %in% c(48, 49, 50, 51, 52, 53)) %>%
  group_by(generation) %>%
  summarise(
    location_sum = sum(geno_pop_mean),
    max_temp = max(max_temp),
...
write_csv(data, here::here("sensitivity_analysis", "thermal_breadth", "mean_shock_large_sum.csv"))
```
