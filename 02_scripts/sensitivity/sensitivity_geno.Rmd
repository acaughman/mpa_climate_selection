...
```{r}
df1 <- read_csv(here::here("sensitivity_analysis", "fishing_pressure", "shock_small5.csv"))

df2 <- read_csv(here::here("sensitivity_analysis", "fishing_pressure", "shock_small6.csv"))

df3 <- read_csv(here::here("sensitivity_analysis", "fishing_pressure", "shock_small7.csv"))

df4 <- read_csv(here::here("sensitivity_analysis", "fishing_pressure", "shock_small8.csv"))
```
...
write_csv(data, here::here("sensitivity_analysis", "fishing_pressure", "shock_small_sum.csv"))
