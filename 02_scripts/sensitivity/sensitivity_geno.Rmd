...
```{r}
df1 <- read_csv(here::here("sensitivity_analysis", "generation_time", "small_enso_4.csv"))

df2 <- read_csv(here::here("sensitivity_analysis", "generation_time", "enso_small_sum_geno.csv")) %>% 
  filter(dd == 0.7) %>%
  mutate(dd = 3)

df3 <- read_csv(here::here("sensitivity_analysis", "generation_time", "small_enso_2.csv"))

# df4 <- read_csv(here::here("sensitivity_analysis", "generation_time", "mean_large8.csv"))
```
...
```{r}
data = full_join(mpa_df1, mpa_df3)
data = full_join(data, df2) %>% 
  mutate(dd = as.factor(dd))

write_csv(data, here::here("sensitivity_analysis", "generation_time", "enso_small_sum_geno.csv"))
