...
```{r}
df1 <- read_csv(here::here("sensitivity_analysis", "fishing_pressure", "med_null_06.csv")) %>% 
  filter(rep == 1)

df2 <- read_csv(here::here("sensitivity_analysis", "fishing_pressure", "null_med_sum.csv")) 
```
