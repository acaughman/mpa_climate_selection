...
```{r}
df1 <- read_csv(here::here("sensitivity_analysis", "fishing_pressure", "med_shock_08.csv"))

df2 <- read_csv(here::here("sensitivity_analysis", "fishing_pressure", "shock_med_sum.csv")) 
```
...
write_csv(data, here::here("sensitivity_analysis", "fishing_pressure", "shock_med_sum.csv"))
```