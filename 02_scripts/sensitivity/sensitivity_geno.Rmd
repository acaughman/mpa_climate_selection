...
```{r}
df1 <- read_csv(here::here("sensitivity_analysis", "fishing_pressure", "mean_large5.csv"))

df2 <- read_csv(here::here("sensitivity_analysis", "fishing_pressure", "mean_large6.csv"))

df3 <- read_csv(here::here("sensitivity_analysis", "fishing_pressure", "mean_large7.csv"))

df4 <- read_csv(here::here("sensitivity_analysis", "fishing_pressure", "mean_large8.csv"))
```
...
write_csv(data, here::here("sensitivity_analysis", "fishing_pressure", "mean_large_sum.csv"))
