...
```{r}
df1 <- read_csv(here::here("sensitivity_analysis", "fishing_pressure", "med_enso.csv")) %>% 
  filter(rep == 1)

df2 <- read_csv(here::here("sensitivity_analysis", "fishing_pressure", "enso_med_sum.csv")) 
```
...
write_csv(data, here::here("sensitivity_analysis", "fishing_pressure", "enso_med_sum.csv"))
```