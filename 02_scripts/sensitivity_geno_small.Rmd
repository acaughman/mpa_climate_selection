...
```{r}
df1 <- read_csv(here::here("sensitivity_analysis", "fishing_pressure", "enso_small5.csv"))

df2 <- read_csv(here::here("sensitivity_analysis", "fishing_pressure", "enso_small6.csv"))

df3 <- read_csv(here::here("sensitivity_analysis", "fishing_pressure", "enso_small7.csv"))

df4 <- read_csv(here::here("sensitivity_analysis", "fishing_pressure", "enso_small8.csv"))
```
...
write_csv(data, here::here("sensitivity_analysis", "fishing_pressure", "enso_small_sum.csv"))
