...
```{r}
df1 <- read_csv(here::here("sensitivity_analysis", "fishing_pressure", "null_med5.csv"))

df2 <- read_csv(here::here("sensitivity_analysis", "fishing_pressure", "null_med6.csv"))

df3 <- read_csv(here::here("sensitivity_analysis", "fishing_pressure", "null_med7.csv"))

df4 <- read_csv(here::here("sensitivity_analysis", "fishing_pressure", "null_med8.csv"))
```
...
ggsave(p, file = paste0("null_med.pdf"), path = here::here("sensitivity_analysis", "fishing_pressure"), height = 8, width = 15)
```
