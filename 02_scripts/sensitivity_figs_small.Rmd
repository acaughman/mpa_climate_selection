...
```{r}
df1 <- read_csv(here::here("sensitivity_analysis", "density_dependence", "shock_001.csv")) %>% 
  mutate(dd = 0.001)

df2 <- read_csv(here::here("sensitivity_analysis", "density_dependence", "shock_002.csv")) %>% 
  mutate(dd = 0.002)

df3 <- read_csv(here::here("sensitivity_analysis", "density_dependence", "shock_003.csv")) %>% 
  mutate(dd = 0.003)

df4 <- read_csv(here::here("sensitivity_analysis", "density_dependence", "shock_004.csv")) %>% 
  mutate(dd = 0.004)

df5 <- read_csv(here::here("sensitivity_analysis", "density_dependence", "shock_005.csv")) %>% 
  mutate(dd = 0.005)
```
...
ggsave(plot, file = paste0("shock.pdf"), path = here::here("sensitivity_analysis", "density_dependence"), height = 8, width = 15)
```
