...
```{r}
output_df <- read_csv(here::here("sensitivity_analysis", "fishing_pressure", "null5.csv"))
```
...
ggsave(plot, file = paste0("null_5_h.pdf"), path = here::here("sensitivity_analysis", "fishing_pressure"), height = 11, width = 8)
```
