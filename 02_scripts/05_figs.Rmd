...
```{r}
output_df = read_csv(here::here("03_generated_data", "full_csv", "test_null.csv"))
```
...
#ggsave(plot, file=paste0("test_mean_early_h.pdf"), path = here::here("04_figs", "time"), height = 11, width = 8)
```
...
#ggsave(p3, file=paste0("test_null6.pdf"), path = here::here("04_figs", "time"), height = 11, width = 8)
```
