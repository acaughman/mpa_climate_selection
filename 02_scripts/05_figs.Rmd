...
```{r}
sum = read_csv(here::here("03_generated_data", "summary_data", "summary_mX.csv"))

geno_sum = read_csv(here::here("03_generated_data", "summary_data", "genotype_summary_mX.csv"))
```
...
#ggsave(plot, file = paste0("null_8_h.pdf"), path = here::here("sensitivity_analysis", "fishing_pressure"), height = 11, width = 8)
```
...
#ggsave(p3, file = paste0("mean_shock_005_1.pdf"), path = here::here("sensitivity_analysis", "density_dependence"), height = 11, width = 8)
```
...
sum_f <- read_csv(here::here("03_generated_data", "summary_data", "test_null_sum_f.csv"))
```

### Typed line plots

```{r}
p5 <- ggplot(sum_f, aes(generation, pop_mean)) +
