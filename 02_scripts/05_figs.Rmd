...
p2 = ggplot(plot_sum, aes(lon, lat, fill = geno_pop_sum)) +
  ...
  theme_bw() +
  scale_fill_gradient2(low = "gainsboro", high = "midnightblue", mid = "skyblue3", midpoint = 5)
```
...
ggsave(plot, file=paste0("test_mean_late_h.pdf"), path = here::here("04_figs", "time"), height = 11, width = 8)
```
...
ggsave(p3, file=paste0("test_mean_late.pdf"), path = here::here("04_figs", "time"), height = 11, width = 8)
```
