...
```{r}
output_df <- read_csv(here::here("sensitivity_analysis", "density_dependence", "mean_shock_005.csv"))
```
...
ggsave(plot, file = paste0("mean_shock_005_1_h.pdf"), path = here::here("sensitivity_analysis", "density_dependence"), height = 11, width = 8)
```
