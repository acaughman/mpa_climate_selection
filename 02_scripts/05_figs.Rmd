...
ggsave(p1, file = paste0("decline_full_1.pdf"), path = here::here("04_figs"), height = 8, width = 15)
```
...
ggsave(p7, file = paste0("collapse_points_1.pdf"), path = here::here("04_figs"), height = 8, width = 8)
```
...
ggsave(p10, file = paste0("decline_mpa_full_1.pdf"), path = here::here("04_figs"), height = 8, width = 15)
```
